# -*- coding: utf-8 -*-
"""
Created on Tue Dec 22 19:00:08 2020
...
dataset = pd.read_csv('C:/Users/DELL/Downloads/stud_reg.csv')
print(type(dataset))
...
line_chart1 = plt.plot(X_test,y_pred, '--',c='g')
line_chart2 = plt.plot(X_test,y_test, ':',c='r')
plt.show()
